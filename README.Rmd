...
Lots to do, make sure scaling happens on compute() with .values, convert from mdim mosaic to xarray, ...

Let's template a bunch of netcdf files out there.  (Note this requires GDAL>=3.12.0 which isn't actually yet). 
